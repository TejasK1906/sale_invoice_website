...
def sale_invoice():
    ...
    cursor.close()
    return render_template('sale_invoice.html', customers=customers,products=products)
...
def submit_form():
    ...
    sale_values = (date,customer_id,customer_name, payment_status, grand_total,cashpaid,credit)
    ...
    for i in range(len(products)):
        ...
        details_values = (new_sale_id,customer_id, product_name, quantity, price,amount)
    ...
    if payment_status == "Credit":
        ...
        balance_values = (date,customer_id, customer_name, "Credit Sale Invoice #" + str(new_sale_id), credit, 0, new_balance)
...
def submit_new_customer():
    ...
    return redirect('/new_customer_success?message=New customer added successfully.')
...
def submit_balance_adjustment():
    ...
    if transaction_type == "Debit":
        ...
        balance_query = "INSERT INTO BalanceDetails (balancedate,CustomerID, CustomerName, Remark, Credit, Debit, Balance) VALUES (%s, %s, %s, %s, %s, %s,%s)"
        balance_values = (date,customer_id, customer_name, "Debit Adjustment - " + payment_method, 0, amount, new_balance)
        cursor.execute(balance_query, balance_values)
    else:
        ...
        balance_query = "INSERT INTO BalanceDetails (balancedate,CustomerID, CustomerName, Remark, Credit, Debit, Balance) VALUES (%s, %s, %s, %s, %s, %s,%s)"
        balance_values = (date,customer_id, customer_name, "Credit Adjustment - " + payment_method, amount, 0, new_balance)
        cursor.execute(balance_query, balance_values)
    ...
    # Optionally, you can pass a success message or redirect to a success page
    return redirect('/balance_adjustment_success?message=Balance adjustment submitted successfully.')
